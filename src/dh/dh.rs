...
impl DH5 {
    /// Create a new DH5 group with a prime value `DH_GROUP_5_PRIME`, generator `2`, and exp_size `192`
    pub fn new() -> Self {
        DH5 {
...
impl DH15 {
    /// Create a new DH15 group with a prime value `DH_GROUP_15_PRIME`, generator `2`, and exp_size `384`
    pub fn new() -> Self {
        DH15 {
            prime_num: BigUint::default(),
            generator: 0,
...
impl DH16 {
    /// Create a new DH16 group with a prime value `DH_GROUP_16_PRIME`, generator `2`, and exp_size `512`
    pub fn new() -> Self {
        DH16 {
            prime_num: BigUint::default(),
            generator: 0,
...
impl DH17 {
    /// Create a new DH17 group with a prime value `DH_GROUP_17_PRIME`, generator `2`, and exp_size `768`
    pub fn new() -> Self {
        DH17 {
            prime_num: BigUint::default(),
            generator: 0,
...
impl DH18 {
    /// Create a new DH18 group with a prime value `DH_GROUP_18_PRIME`, generator `2`, and exp_size `1024`
    pub fn new() -> Self {
        DH18 {
            prime_num: BigUint::default(),
            generator: 0,
